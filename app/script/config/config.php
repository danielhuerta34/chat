...
$config["includeTemplateJS"] = false;
/******************************** template settings ***********************************/
...
//block css settings
$config["blockClass"] = array("col-md-10", "col-sm-10", "col-lg-10");
//block label settings
$config["lableClass"] = array("col-md-2", "col-sm-2", "col-lg-2");
...
$config["SMTPusername"] = "dany.huertar@gmail.com"; 

$config["SMTPpassword"] = "M1%3rf9as";
