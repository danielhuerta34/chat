...
function(t) {
	...
	function it(t, e) {
		...
		if (e) for (n = 0; n < e.length; n++) {
			for (i = e[n], r = [], s = t.length - 1; s >= 0; s--) if ("object" == typeof(o = t[s][i])) r.unshift(o);
			else if (void 0 !== o) {
				l[i] = o;
				break
			}
	...
	be.mixin({
		...
		eventsToSegs: function(e, n) {
			...
			return t.each(r, function(t, e) {
				...
				if (kt(e[0])) for (l = i.invertRanges(l), o = 0; o < l.length; o++) s.push.apply(s, i.eventRangeToSegs(l[o], e[0], n));
				else
